...
import ContactInfo from "@src/components/ResumePreview/ContactInfo";
import {MdEmail, MdLocationOn, MdPhone} from "react-icons/md";
import DateRange from "@src/components/ResumePreview/DateRange";
import Skills from "@src/components/ResumePreview/Skills";
import Language from "@src/components/ResumePreview/Language";
import Certification from "@src/components/ResumePreview/Certification";
...
const Template4 = () => {
  ...
  return (
      <>
        ...
        <div className="resume md:overflow-y-scroll opacity-1 flex flex-col">
