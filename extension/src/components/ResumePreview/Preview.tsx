...
import professionalCss from "@src/assets/styles/templates/professional.css?inline"
...
const Preview = React.forwardRef((props, ref) => {
  ...
  // function cssToReactStyle(css: string): CSSStyle {
  ...
  //     // Check for valid property names (avoid potential errors)
  ...
  return (
      ...
      {/*<div className="preview md:overflow-y-scroll opacity-1 flex flex-col" ref={ref}>*/}
